 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://service.export.cy.com/", wsdlLocation = "http://localhost:8080/export/ws/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://service.export.cy.com/", "WeatherServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/export/ws/weather?wsdl");
    ...
    public WeatherService getWeatherServicePort() {
        return super.getPort(new QName("http://service.export.cy.com/", "WeatherServicePort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.export.cy.com/", "WeatherServicePort"), WeatherService.class, features);
    }
